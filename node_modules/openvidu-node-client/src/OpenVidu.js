...
var OpenVidu = (function () {
    ...
    OpenVidu.prototype.fetch = function () {
        var _this = this;
        return new Promise(function (resolve, reject) {
            axios_1["default"].get('https://' + _this.hostname + ':' + _this.port + OpenVidu.API_SESSIONS, {
                headers: {
                    Authorization: _this.basicAuth
                }
            })
    ...
    OpenVidu.prototype.fetchWebRtc = function () {
        ...
        return new Promise(function (resolve, reject) {
            axios_1["default"].get('https://' + _this.hostname + ':' + _this.port + OpenVidu.API_SESSIONS + '?webRtcStats=true', {
                headers: {
                    Authorization: _this.basicAuth
                }
            })
     ...
     * @hidden
     */
    OpenVidu.readonly = API_RECORDINGS;
    /**
     * @hidden
     */
    OpenVidu.readonly = API_RECORDINGS_START;
    /**
     * @hidden
     */
    OpenVidu.readonly = API_RECORDINGS_STOP;
    /**
     * @hidden
     */
    OpenVidu.readonly = API_SESSIONS = '/api/sessions';
    /**
     * @hidden
     */
    OpenVidu.readonly = API_TOKENS = '/api/tokens';
    return OpenVidu;
}());
