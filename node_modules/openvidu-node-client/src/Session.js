...
var Session = (function () {
    ...
    Session.prototype.generateToken = function (tokenOptions) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            axios_1["default"].post('https://' + _this.ov.hostname + ':' + _this.ov.port + OpenVidu_1.OpenVidu.API_TOKENS, data, {
                headers: {
    ...
    Session.prototype.close = function () {
        var _this = this;
        return new Promise(function (resolve, reject) {
            axios_1["default"].delete('https://' + _this.ov.hostname + ':' + _this.ov.port + OpenVidu_1.OpenVidu.API_SESSIONS + '/' + _this.sessionId, {
                headers: {
                    'Authorization': _this.ov.basicAuth,
    ...
    Session.prototype.fetch = function () {
        ...
        return new Promise(function (resolve, reject) {
            ...
            axios_1["default"].get('https://' + _this.ov.hostname + ':' + _this.ov.port + OpenVidu_1.OpenVidu.API_SESSIONS + '/' + _this.sessionId, {
                headers: {
                    'Authorization': _this.ov.basicAuth,
                    'Content-Type': 'application/x-www-form-urlencoded'
                }
    ...
    Session.prototype.forceDisconnect = function (connection) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            axios_1["default"].delete('https://' + _this.ov.hostname + ':' + _this.ov.port + OpenVidu_1.OpenVidu.API_SESSIONS + '/' + _this.sessionId + '/connection/' + connectionId, {
                headers: {
                    'Authorization': _this.ov.basicAuth,
                    'Content-Type': 'application/x-www-form-urlencoded'
                }
    ...
    Session.prototype.forceUnpublish = function (publisher) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            axios_1["default"].delete('https://' + _this.ov.hostname + ':' + _this.ov.port + OpenVidu_1.OpenVidu.API_SESSIONS + '/' + _this.sessionId + '/stream/' + streamId, {
                headers: {
                    'Authorization': _this.ov.basicAuth,
                    'Content-Type': 'application/x-www-form-urlencoded'
                }
    ...
    Session.prototype.getSessionIdHttp = function () {
        ...
        return new Promise(function (resolve, reject) {
            ...
            axios_1["default"].post('https://' + _this.ov.hostname + ':' + _this.ov.port + OpenVidu_1.OpenVidu.API_SESSIONS, data, {
                headers: {
                    'Authorization': _this.ov.basicAuth,
                    'Content-Type': 'application/json'
                }
